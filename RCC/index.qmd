...
* [**t-test via boostrap**]{.hl-yellow}: now we fixed `calculate(stat = "diff in means")`, and we **exchange again the values of group variable** via permutation.
...
## 🐣 Case study I: turnout vs candidates {#caso-practico-4-4}
...
```{r}
datos <- read_csv(file = "./data/blackturnout.csv") |> janitor::clean_names()
...
## 🐣 Case study II: attractiveness vs alcohol {#caso-practico-4-5}
